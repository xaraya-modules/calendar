...
$pass1  = [1998, 2, 1] == (new Date_Calc())->isoWeekDate(5, 1, 1998) ? true : false;
$pass2  = [1998, 2, 2] == (new Date_Calc())->isoWeekDate(6, 1, 1998) ? true : false;
$pass3  = [2004, 2, 1] == (new Date_Calc())->isoWeekDate(5, 1, 2004) ? true : false;
$pass4  = [2004, 2, 2] == (new Date_Calc())->isoWeekDate(6, 1, 2004) ? true : false;
